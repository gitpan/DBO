package DBO::Value::Column;

=head1 NAME

DBO::Value::Column - The value in a single colummn.
...
sub init
{
    ...
    assert(UNIVERSAL::isa($_[0],'DBO::Meta::ColumnInfo'), __PACKAGE__ .' requires column info object');
