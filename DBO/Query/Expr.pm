package DBO::Query::Expr;

=head1 NAME

DBO::Query::Expr - Abstraction of a WHERE or ON clause.
...
use Carp::Assert;
use DBO::Util qw(ctx_0 is_same_value);
...
## Same as new DBO::Query::Expr(@_)
sub expr
{
    new DBO::Query::Expr(@_)
}
...
sub walk_expr
{
    ...
    return '?' if $e eq DBO::Query->PlaceHolder;
