package DBO::Meta::HasA;

=head1 NAME

DBO::Meta::HasA - One side of a one-to-many relationship.
...
sub init
{
    ...
    $opts ||= {};
        ...
        assert(UNIVERSAL::isa($one_to_many,'DBO::Meta::OneToMany'), 'HasA->new requires OneToMany');
