package DBO::Meta::HasMany;

=head1 NAME

DBO::Meta::HasMany - One side of a one-to-many relationship.
...
sub init
{
    ...
    $opts ||= {};
        ...
        assert(UNIVERSAL::isa($one_to_many,'DBO::Meta::OneToMany'), 'HasMany->new requires OneToMany');
